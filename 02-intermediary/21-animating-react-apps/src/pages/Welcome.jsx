...
export default function WelcomePage() {
  // scrollY and X tells us for how many pixels the user scrolled
  // scrollYProgress return relative values, 1 if user scrolled, 0 if not
  const { scrollY } = useScroll()

// This basically means, after 200 px scrolled, the value (in this case will be the opacity value)
// decreases to 0.5, same at 300 px, and when reach 500px, it is 0
  ...
  return (
    <>
      <header id="welcome-header">
        <motion.div id="welcome-header-content" style={{
          scale: scaleText,
          y: yText
        }}>
